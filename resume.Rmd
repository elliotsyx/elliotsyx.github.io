...
Skills learned: SQL, R, Tableau (data visualization), Excel (data summary and cleaning) Completed Google Career Certificate training to build technical skills in data analysis Curriculum included data cleaning, data visualization, project management, and data analytics with the goal of developing the ability to transform complex data into actionable insights
...
Project involved determining the factors that increase the likelihood of having a highway-rail grade crossing accident, with focus on finding root causes. Designed case study research on a large database of Highway-Rail Grade Crossing Accident using RStudio. Work included cleaning and analyzing over 2 million data points Used linear regression modeling to verify results from calculations of Massachusetts Monthly Traffic Volume over the past 6 years; merged original data with updated dataset to create useable resource for future researchers



Human Perception Labs with Professor Sam Ling at Boston University 
...
Lingxin Intelligence, Intern Data Analyst 
...
USTest Educational Center, Intern Data Analyst 
...
GreatChina Studyabroad Testing Center, English Teaching Assistant 
...
Boston University Chinese Student Scholars Association 

08/2020-03/2022

As member of Recreation Department: organized social programs, festival celebrations, and cultural sharing activities for over 1500 Chinese international students at Boston


Boston University International Student Mentors 
